(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 19556))
 (memory $0 1)
 ...
 (data (i32.const 1148) ",")
 (data (i32.const 1160) "\03\00\00\00\10\00\00\00p\04\00\00p\04")
 (data (i32.const 1196) ",")
 ...
 (data (i32.const 2588) ",")
 (data (i32.const 2600) "\01\00\00\00\0e\00\00\00n\00o\00-\00c\00o\00r\00s")
 (data (i32.const 2636) ",")
 (data (i32.const 2648) "\01\00\00\00\14\00\00\00R\00e\00s\00p\00o\00n\00s\00e\00:\00 ")
 (data (i32.const 2684) "<")
 ...
 (data (i32.const 2812) ",")
 (data (i32.const 2824) "\01\00\00\00\1c\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s")
 (data (i32.const 2860) "\1c")
 (data (i32.const 2872) "\11\00\00\00\08\00\00\00\02")
 (data (i32.const 2892) "<")
 (data (i32.const 2904) "\01\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d")
 (data (i32.const 2956) "<")
 (data (i32.const 2968) "\01\00\00\00(\00\00\00O\00b\00j\00e\00c\00t\00 \00i\00s\00 \00n\00o\00t\00 \00p\00i\00n\00n\00e\00d")
 (data (i32.const 3024) "\12\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 3052) "\02\t")
 (data (i32.const 3068) "\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00 \00\00\00\00\00\00\00A\00\00\00\02\00\00\00\04A")
 (data (i32.const 3116) "\10A\82")
 (data (i32.const 3128) "\0d")
 (data (i32.const 3140) " ")
 (table $0 3 funcref)
             ...
             block $~lib/array/Array<i32>
              block $~lib/string/String
               block $~lib/arraybuffer/ArrayBuffer
                ...
                i32.sub
                i32.load
                br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner3 $~lib/array/Array<i32> $assembly/request/RequestInit $folding-inner1 $folding-inner1 $assembly/fetch/Fetch $folding-inner3 $~lib/staticarray/StaticArray<~lib/string/String> $folding-inner3 $~lib/map/Map<~lib/string/String,~lib/array/Array<~lib/string/String>> $assembly/response/Response $folding-inner3 $assembly/status/Status $folding-inner0 $folding-inner2 $folding-inner2 $invalid
               end
               return
              end
              return
 ...
 (func $assembly/fetch/test~anonymous|0 (param $0 i32)
  ...
  i32.const 1
  i32.store8 offset=4
  block $__inlined_func$assembly/body/Body#text
   local.get $0
   i32.load
   i32.eqz
   if
    ...
    i32.const 1792
    local.set $0
    br $__inlined_func$assembly/body/Body#text
   end
   global.get $~lib/memory/__stack_pointer
   local.get $0
   i32.load
