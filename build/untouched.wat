(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 11428))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 27812))
 (global $~lib/memory/__heap_base i32 (i32.const 27812))
 (memory $0 1)
 ...
 (data (i32.const 11264) "\14\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00A\00\00\00\02\00\00\00\02\t\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00\04A\00\00\00\00\00\00\00\00\00\00\00\00\00\00\10A\82\00\00\00\00\00\00\00\00\00\0d\00\00\00\00\00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 3 funcref)
 ...
 (func $assembly/Blob/Blob#set:_buffer (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
  local.get $0
 ...
 (func $assembly/Blob/Blob#set:_type (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/Blob/BlobOptions#set:type (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/Blob/Blob~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.tee $2
 ...
 (func $assembly/Blob/BlobOptions~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.tee $2
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $~lib/function/Function<%28assembly/response/Response%29=>void>
    block $assembly/Blob/BlobOptions
     ...
     local.get $0
     local.get $1
     call $assembly/Blob/Blob~visit
     return
    end
    local.get $0
    local.get $1
    call $assembly/Blob/BlobOptions~visit
    return
   end
   local.get $0
   local.get $1
 ...
 (func $assembly/Blob/Blob#constructor (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  local.get $0
  i32.const 1344
  call $assembly/Blob/Blob#set:_type
  local.get $0
  i32.const 0
  call $assembly/Blob/Blob#set:_buffer
  local.get $0
  local.get $1
  call $assembly/Blob/Blob#set:_buffer
  local.get $2
 ...
 (func $assembly/body/Body#blob (param $0 i32) (result i32)
  ...
  if
   ...
   local.get $1
   i32.const 1344
   call $assembly/Blob/BlobOptions#set:type
   local.get $1
   local.set $3
   global.get $~lib/memory/__stack_pointer
   local.get $3
 ...
 (func $assembly/Blob/Blob#text (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/fetch/test~anonymous|0 (param $0 i32)
  ...
  local.get $2
  local.get $1
  call $assembly/Blob/Blob#toString
  local.set $2
  global.get $~lib/memory/__stack_pointer
  local.get $2
  i32.store offset=12
 ...
 (func $assembly/Blob/BlobOptions#constructor (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
